...
$(document).ready(function () {
    ...
    for ( var j=0; j<facilities.length; j++)
    {
        ...
        $('#htmlContentQUIC'+j).append( '<h2 align="middle">Safer Clinics Scorecard <br> Progress towards Emergency Obstetric and Neonatal Care Status, From :  <label id="startPeriod'+j+'">'+fromPeriod+'</label> To : <label id="endPeriod'+j+'">' +toPeriod+' </label>  </h2>');
        ...
        $('#facilityScorecard'+j).append( '<p id="enablerP'+j+'" align="middle">Safer Clinic Scorecard: District : <label id="districtName'+j+'">'+ selectedDistrictName +'</label> Facility : <label id="facilityName'+j+'">'+ facilities[j].name + '</label> </p>' );
        ...
        $('#facilityScorecard'+j).append( '<p id="dataElementP'+j+'" align="middle">Safer Clinic Scorecard: District : <label id="districtName2'+j+'">'+ selectedDistrictName +'</label> Facility : <label id="facilityName1'+j+'">'+ facilities[j].name + '</label> Signal Functions </p>' );
