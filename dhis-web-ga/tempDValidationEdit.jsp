...
<%
	// Input Parameters
	String dvID = request.getParameter("dvIDHB");
...
*/	
	...
	boolean editVStatus = DataValidationAction.editDataValidation(li);
%>
<html>
	<head>
		...
		<script>
			function onLoadFunction()
			{
			  ...
			  if(<%=editVStatus%>) 
			  	{
			  		alert("Validation is Successfully Updated");
			  		location.href="DValidationScreen.jsp";
			  	}
			  else
			  	{
			  		alert("Failure while Editing...Try Again");
			  		location.href="DValidationEdit.jsp?dvid="+dvID;
			  	}		
			}
		</script>
	</head>
