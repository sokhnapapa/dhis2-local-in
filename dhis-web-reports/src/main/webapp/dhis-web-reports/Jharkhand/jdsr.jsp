...
//	int selectedDataPeriodID = 	Integer.parseInt( selectedPeriodId );
	...
	String monthlyDataElements[] = {
  											...
  											// Diptheria - Cases ( Male + Female), Deaths (Male + Female)											
  											"Form6_DE84","Form6_DE85",  "Form6_DE90","Form6_DE91",
  											
  											// Measles - Cases (Male + Female), Deaths (Male + Female)
  											"Form6_DE108","Form6_DE109", "Form6_DE114","Form6_DE115",
  											
  											// Neonatal Tetanus - Cases (Male + Female), Deaths (Male + Female)
  											"Form6_DE100","Form6_DE101", "Form6_DE106","Form6_DE107",
...
<HTML>
	<HEAD>
		<TITLE>DISEASE SURVEILANCE REPORT</TITLE>
	</HEAD>
	<BODY>
		<P align="center"><FONT face="Arial" size="3"><b>DISEASE SURVEILANCE REPORT<BR>
		...
		<%
				  ...
				  while(count < childOrgUnitCount)
				     ...
				     <TABLE style="BORDER-COLLAPSE: collapse" borderColor=#111111 cellSpacing=3 cellPadding=3 width="100%" border=1>
  						<TR>
  							<TD align="center" width="3%" rowSpan=2><B><FONT face="Arial" size="2">&#2325;&#2381;&#2352;&#2350;&#2366;&#2306;&#2325;</FONT></B></TD>
   							<TD align="center" width="49%" rowSpan=2><B><FONT face="Arial" size="2">&#2313;&#2346;&#2325;&#2375;&#2306;&#2342;&#2381;&#2352; &#2325;&#2366; &#2344;&#2366;&#2350;</FONT></B></TD>
   							<TD align="center" width="12%" colspan="2"><b><font face="Arial" size="2">DIPHTHERIA</font></b></TD>
   							<TD align="center" width="12%" colspan="2"><b><font face="Arial" size="2">MEASLES</font></b></TD>
   							<TD align="center" width="12%" colspan="2"><b><font face="Arial" size="2">NEONATAL TETANUS</font></b></TD>
   							<TD align="center" width="12%" colspan="2"><b><font face="Arial" size="2">PERTUSIS</font></b></TD>
    					</TR>
  						<TR>
   							<TD align="center" width="6%"><b><font face="Arial" size="2">Cases</font></b></TD>
    					...
    					<TR>
    						...
    						<TD width="49%" HEIGHT="30" align="center"><FONT face="Arial" size="2"><i><b>2</b></i></FONT></TD>
    						<TD width="6%"  HEIGHT="30" align="center"><FONT face="Arial" size="2"><i><b>3</b></i></FONT></TD>
    						<TD width="6%"  HEIGHT="30" align="center"><b><i><font face="Arial" size="2">4</font></i></b></TD>
    						<TD width="6%"  HEIGHT="30" align="center"><FONT face="Arial" size="2"><i><b>5</b></i></FONT></TD>
    						<TD width="6%"  HEIGHT="30" align="center"><b><i><font face="Arial" size="2">6</font></i></b></TD>
    						<TD width="6%"  HEIGHT="30" align="center"><FONT face="Arial" size="2"><i><b>7</b></i></FONT></TD>
    						<TD width="6%"  HEIGHT="30" align="center"><b><i><font face="Arial" size="2">8</font></i></b></TD>
    						<TD width="6%"  HEIGHT="30" align="center"><FONT face="Arial" size="2"><i><b>9</b></i></FONT></TD>
    						<TD width="6%"  HEIGHT="30" align="center"><b><i><font face="Arial" size="2">10</font></i></b></TD>
    					</TR>	
				   ...
				   %>			     				  		             		
  					...
  					<TR>
    					...
    					<TD width="49%" HEIGHT="30" align="center"><FONT face="Arial" size="2"><%=childOrgUnitNames.get(count)%></font></TD>
    					...
    					<TD width="6%"  HEIGHT="30" align="center"><FONT face="Arial" size="2"><%=(tempval[6]+tempval[7])%></font></TD>
    					<TD width="6%"  HEIGHT="30" align="center"><FONT face="Arial" size="2"><%=(tempval[8]+tempval[9])%></font></TD>
    					<TD width="6%"  HEIGHT="30" align="center"><FONT face="Arial" size="2"><%=(tempval[10]+tempval[11])%></font></TD>
  		...
  		%>
			...
			<TR>
				...
				<TD width="49%" HEIGHT="30" align="center"><FONT face="Arial" size="2"><b>&#2325;&#2369;&#2354;</b></font></TD>
				...
				<TD width="6%"  HEIGHT="30" align="center"><FONT face="Arial" size="1"><%=(total[6]+total[7])%></font></TD>
				<TD width="6%"  HEIGHT="30" align="center"><FONT face="Arial" size="1"><%=(total[8]+total[9])%></font></TD>
				<TD width="6%"  HEIGHT="30" align="center"><FONT face="Arial" size="1"><%=(total[10]+total[11])%></font></TD>
