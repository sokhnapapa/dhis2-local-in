...
//	   		if(rs2.next()) 	  {  selectedDataPeriodStartDate =  rs2.getDate(1).toString();	} 		  
			...
			//rs7=st7.executeQuery("select organisationunit.id, organisationunit.shortname FROM organisationunit WHERE organisationunit.id in ( select organisationunit.parent from organisationunit where organisationunit.id = "+CHCID+")");
     ...
     {     
     	for(i=0;i<15;i++)	  
			{	  
				...
				rs4 = st4.executeQuery(" select sum(value) from datavalue where dataelementid in (select dataelementid from dataelement where code like '"+monthlyDataElements[i]+"') and sourceid in (select organisationunitid from organisationunit where organisationunitid in ( select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+") or organisationunitid = "+selectedOrgUnitID+") and periodid in (select periodid from period where startdate between '"+curYearStart+"' and '"+selectedDataPeriodStartDate+"' and periodtypeid = "+periodTypeID+")");        			        		
...
<body>	
   <center>
	...
	<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
	  	...
	  	<tr>
          <td width="100%" colspan="9" align="center" style="border-left-style: solid; border-left-width: 1; border-right-style: solid; border-right-width: 1; border-top-width: 0; border-bottom-width: 0"><font face="Arial" size="3"><b>
          &#2360;&#2368;. &#2361;&#2375;&#2330;. &#2360;&#2368;. &#2346;&#2381;&#2352;&#2340;&#2367;&#2357;&#2375;&#2342;&#2344;</b></font></td></tr>
	  	<tr>
    			<td width="50%" height="25" colspan="4" style="border-left-style: solid; border-left-width: 1; border-right-style: solid; border-right-width: 0; border-top-width: 0; border-bottom-width: 0"><font face="Arial" size="2">
                &#2360;&#2368;. &#2361;&#2375;&#2330;. &#2360;&#2368;.&nbsp;&nbsp;&nbsp;&nbsp;<%=selectedOrgUnitName%></font></td>
