     ...
     try
      {
	        ...
	        rs11=st11.executeQuery("select organisationunit.organisationunitid, organisationunit.shortname FROM organisationunit WHERE organisationunit.organisationunitid in ( select organisationunit.parentid from organisationunit where organisationunit.organisationunitid = "+PHCID+")");        
			if(rs11.next())  { CHCID = rs11.getInt(1);CHCName = rs11.getString(2);  } 
			else  {  CHCID = 0; CHCName = "";  } 
			
        
		    rs6=st6.executeQuery("select organisationunit.organisationunitid, organisationunit.shortname FROM organisationunit WHERE organisationunit.organisationunitid in ( select organisationunit.parentid from organisationunit where organisationunit.organisationunitid = "+CHCID+")"); 
...
<HEAD>
   ...
   <script src="../dhis-web-reports/MadhyaPradesh/MPDENamesForForm6.js" type="text/javascript" language="Javascript"></script> 	
   <script>
   		function fun1()
        	{         	    
        		var start=0;
 		...
 		<tr>
  		...
  		<tr>
    		<td width="50%" style="border-collapse: collapse; border-left-style: solid; border-left-width: 0; border-right-style: solid; border-right-width: 0; padding-left:15; padding-right:0; padding-top:0; padding-bottom:0" bordercolor="#111111" width="100%" height="19">
       			<font face="Arial" size="2">5.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#2346;&#2381;&#2352;.&#2360;&#2381;&#2357;&#2366;.&#2325;&#2375;&#2306;. &#2325;&#2368; &#2332;&#2344;&#2360;&#2306;&#2325;&#2381;&#2351;&#2366; :&nbsp;&nbsp;&nbsp;&nbsp;</font>
    		</td>
  		...
  		<tr>
    		<td width="50%" style="border-collapse: collapse; border-left-style: solid; border-left-width: 0; border-right-style: solid; border-right-width: 0; padding-left:15; padding-right:0; padding-top:0; padding-bottom:0" bordercolor="#111111" width="100%" height="1" colspan="2">
            	<font face="Arial" size="2">6.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&#2313;&#2346;&#2325;&#2375;&#2306;&#2342;&#2381;&#2352; &#2325;&#2368; &#2332;&#2344;&#2360;&#2306;&#2325;&#2381;&#2351;&#2366; :&nbsp;&nbsp;&nbsp;&nbsp;</font>
	       	</td>
      		<td width="50%" style="border-collapse: collapse; border-left-style: solid; border-left-width: 0; border-right-style: solid; border-right-width: 0; padding-left:15; padding-right:0; padding-top:0; padding-bottom:0" bordercolor="#111111" width="100%" height="19"> </td>
  		</tr>
  </table>  
