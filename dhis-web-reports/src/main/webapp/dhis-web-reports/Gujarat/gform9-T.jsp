		...
		while(i!=j) 
			{		
				...
				if(i==84 || i==85 || i==86) // 3.15
				  //query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataElement = dataelement.id WHERE datavalue.period  in (select id from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.source in (select id from organisationunit where id  in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% UFWC' OR shortname LIKE '% UHP') OR parent in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% UFWC' OR shortname LIKE '% UHP')) AND dataelement.code in ("+dataElementCodes[i]+")";
				  query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataelementid = dataelement.dataelementid WHERE datavalue.periodid  in (select periodid from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.sourceid in (select organisationunitid from organisationunit where organisationunitid  in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% UFWC' OR shortname LIKE '% UHP') OR parentid in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% UFWC' OR shortname LIKE '% UHP')) AND dataelement.code in ("+dataElementCodes[i]+")";
				else if(i==93 || i==94 || i==95 || i==234 || i==235 || i==236) // 3.22, 6.11
				  //query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataElement = dataelement.id WHERE datavalue.period  in (select id from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.source in (select id from organisationunit where id  in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% - 24 hours') OR parent in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% - 24 hours')) AND dataelement.code in ("+dataElementCodes[i]+")";
				  query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataelementid = dataelement.dataelementid WHERE datavalue.periodid  in (select periodid from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.sourceid in (select organisationunitid from organisationunit where organisationunitid  in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% - 24 hours') OR parentid in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% - 24 hours')) AND dataelement.code in ("+dataElementCodes[i]+")";				
				else if(i==96 || i==97 || i==98 || i==237 || i==238 || i==249) // 3.23, 6.12
				  //query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataElement = dataelement.id WHERE datavalue.period  in (select id from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.source in (select id from organisationunit where id  in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% PHC') OR parent in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% PHC')) AND dataelement.code in ("+dataElementCodes[i]+")";
				  query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataelementid = dataelement.dataelementid WHERE datavalue.periodid  in (select periodid from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.sourceid in (select organisationunitid from organisationunit where organisationunitid  in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% PHC') OR parentid in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% PHC')) AND dataelement.code in ("+dataElementCodes[i]+")";								
				else if(i==240 || i==241 || i==242 || i==270 || i==271 || i==272) // 6.13, 7.11
				  //query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataElement = dataelement.id WHERE datavalue.period  in (select id from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.source in (select id from organisationunit where id  in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% CHC') OR parent in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% CHC')) AND dataelement.code in ("+dataElementCodes[i]+")";
				  query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataelementid = dataelement.dataelementid WHERE datavalue.periodid  in (select periodid from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.sourceid in (select organisationunitid from organisationunit where organisationunitid  in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% CHC') OR parentid in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% CHC')) AND dataelement.code in ("+dataElementCodes[i]+")";
				else if(i==243 || i==244 || i==245 || i==273 || i==274 || i==275) // 6.14, 7.12
				  //query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataElement = dataelement.id WHERE datavalue.period  in (select id from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.source in (select id from organisationunit where id  in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% FRU') OR parent in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% FRU')) AND dataelement.code in ("+dataElementCodes[i]+")";
				  query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataelementid = dataelement.dataelementid WHERE datavalue.periodid  in (select periodid from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.sourceid in (select organisationunitid from organisationunit where organisationunitid  in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% FRU') OR parentid in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% FRU')) AND dataelement.code in ("+dataElementCodes[i]+")";								
				else if(i==246 || i==247 || i==248) // 6.15
				  //query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataElement = dataelement.id WHERE datavalue.period  in (select id from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.source in (select id from organisationunit where id  in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% SDH') OR parent in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% SDH')) AND dataelement.code in ("+dataElementCodes[i]+")";
				  query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataelementid = dataelement.dataelementid WHERE datavalue.periodid  in (select periodid from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.sourceid in (select organisationunitid from organisationunit where organisationunitid  in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% SDH') OR parentid in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% SDH')) AND dataelement.code in ("+dataElementCodes[i]+")";								
				else if(i==282 || i==283 || i==284) // 7.15
				  //query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataElement = dataelement.id WHERE datavalue.period  in (select id from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.source in (select id from organisationunit where id  in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% PPU') OR parent in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% PPU')) AND dataelement.code in ("+dataElementCodes[i]+")";
				  query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataelementid = dataelement.dataelementid WHERE datavalue.periodid  in (select periodid from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.sourceid in (select organisationunitid from organisationunit where organisationunitid  in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% PPU') OR parentid in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+" AND shortname LIKE '% PPU')) AND dataelement.code in ("+dataElementCodes[i]+")";
				else if(i==404)
				  //query = "SELECT count(*) FROM datavalue INNER JOIN dataelement ON datavalue.dataElement = dataelement.id WHERE datavalue.period  in (select id from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.source in (select id from organisationunit where id = "+selectedOrgUnitID+" OR id  in (select id from organisationunit where parent = "+selectedOrgUnitID+") OR parent in (select id from organisationunit where parent = "+selectedOrgUnitID+")) AND dataelement.code in ("+dataElementCodes[i]+") AND datavalue.value >= 10 ";
				  query = "SELECT count(*) FROM datavalue INNER JOIN dataelement ON datavalue.dataelementid = dataelement.dataelementid WHERE datavalue.periodid  in (select periodid from period where startdate between '"+startingDate+"' and '"+startingDate+"') AND datavalue.sourceid in (select organisationunitid from organisationunit where organisationunitid = "+selectedOrgUnitID+" OR organisationunitid  in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+") OR parentid in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+")) AND dataelement.code in ("+dataElementCodes[i]+") AND datavalue.value >= 10 ";				
				else 
				...
				if(i==84 || i==85 || i==86) // 3.15
				  //query = "SELECT sum(datavalue.value) FROM datavalue INNER JOIN dataelement ON datavalue.dataElement = dataelement.id WHERE datavalue.period  in (select id from period where startdate between '"+curYearStart+"' and '"+selectedDataPeriodStartDate+"') AND datavalue.source in (select id from organisationunit where id  in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% UFWC' OR shortname LIKE '% UHP') OR parent in (select id from organisationunit where parent = "+selectedOrgUnitID+" AND shortname LIKE '% UFWC' OR shortname LIKE '% UHP')) AND dataelement.code in ("+dataElementCodes[i]+")";
				  ...
				  //query = "SELECT count(*) FROM datavalue INNER JOIN dataelement ON datavalue.dataElement = dataelement.id WHERE datavalue.period  in (select id from period where startdate between '"+curYearStart+"' and '"+selectedDataPeriodStartDate+"') AND datavalue.source in (select id from organisationunit where id = "+selectedOrgUnitID+" OR id  in (select id from organisationunit where parent = "+selectedOrgUnitID+") OR parent in (select id from organisationunit where parent = "+selectedOrgUnitID+")) AND dataelement.code in ("+dataElementCodes[i]+") AND datavalue.value >= 10 ";
				  query = "SELECT count(*) FROM datavalue INNER JOIN dataelement ON datavalue.dataelementid = dataelement.dataelementid WHERE datavalue.periodid  in (select periodid from period where startdate between '"+curYearStart+"' and '"+selectedDataPeriodStartDate+"') AND datavalue.sourceid in (select organisationunitid from organisationunit where organisationunitid = "+selectedOrgUnitID+" OR organisationunitid  in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+") OR parentid in (select organisationunitid from organisationunit where parentid = "+selectedOrgUnitID+")) AND dataelement.code in ("+dataElementCodes[i]+") AND datavalue.value >= 10 ";				
				else 
