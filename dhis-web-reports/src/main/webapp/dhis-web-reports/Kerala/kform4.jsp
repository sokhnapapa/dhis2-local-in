...
<HEAD>
   <TITLE>Form - 4</TITLE>
   <script src="../dhis-web-reports/Kerala/KDENamesForForm4.js" type="text/javascript" language="Javascript"></script> 	
   <script>
   		function fun1()
        	{ 
...
<BODY BGCOLOR="#FFFFFF" onload="fun1()">  
	<font face="Arial" size="2">(To be submitted by 25th March to the State 
    Family Welfare Officer and Dept of Family Welfare, MOHFW , GOI , New Delhi 
    through NICNET)</font>
	<center>
		<font face="Arial" size="3">
			<b>FORM 4<br>DISTRICT ACTION PLAN</b></font>
	</center>
		...
		<table cellpadding="0" cellspacing="0" bgcolor="ffffff" align="center" style="border-style:solid; border-width:0; border-collapse: collapse; padding: 0; position:relative; top:10" bordercolor="#ffffff" width="100%"  border="0">
 		...
 		<tr>
    			<td width="60%" style="border-collapse: collapse; border-left-style: solid; border-left-width: 0; border-right-style: solid; border-right-width: 0; padding-left:15; padding-right:0; padding-top:0; padding-bottom:0" bordercolor="#111111" height="19">
       				<font face="Arial" size="2">District : &nbsp;&nbsp;<%=selectedOrgUnitName%></font>
    		</td>
    			<td width="40%" style="border-collapse: collapse; border-left-style: solid; border-left-width: 0; border-right-style: solid; border-right-width: 0; padding-left:15; padding-right:0; padding-top:0; padding-bottom:0" bordercolor="#111111"  height="19">
 		...
 		<tr>
    			<td width="60%" style="border-collapse: collapse; border-left-style: solid; border-left-width: 0; border-right-style: solid; border-right-width: 0; padding-left:15; padding-right:0; padding-top:0; padding-bottom:0" bordercolor="#111111" height="19">
       				<font face="Arial" size="2">No. of PHC in that District : &nbsp;&nbsp;</font>
    		</td>
    			<td width="40%" style="border-collapse: collapse; border-left-style: solid; border-left-width: 0; border-right-style: solid; border-right-width: 0; padding-left:15; padding-right:0; padding-top:0; padding-bottom:0" bordercolor="#111111"  height="19">
       				(as on 1st April)</td>
  		</tr>		
 		<tr>
    			<td width="60%" style="border-collapse: collapse; border-left-style: solid; border-left-width: 0; border-right-style: solid; border-right-width: 0; padding-left:15; padding-right:0; padding-top:0; padding-bottom:0" bordercolor="#111111" height="19">
       				<font face="Arial" size="2">Population of the District : </font>
    		</td>
    			<td width="40%" style="border-collapse: collapse; border-left-style: solid; border-left-width: 0; border-right-style: solid; border-right-width: 0; padding-left:15; padding-right:0; padding-top:0; padding-bottom:0" bordercolor="#111111"  height="19">
       				&nbsp;</td>
  		</tr>		
...
int bt =0; 	
 	while(j<=5)
 	 { 
		...
		if(j==1) endcount = 26; 
		else if(j==2) endcount = 35; 
		else if(j==3) endcount = 35;
		else if(j==4) endcount = 25;
               ...
               if(k==27) 
               ...
               else if(k==77) 
 	            {
 	              ...
 	              tempForentryNumberValues[0]= "<b>Unit</b>";
	 	             tempForentryNumberValues[1]= "<b>Qty .used in<br>previous Year</b>";
					  tempForentryNumberValues[2]= "<b>Stock position<br>on 1st April</b>";
					  tempForentryNumberValues[3]= "<b>Additional quantity<br>required in<br>current year</b>";
 	              
 	              l=l+4;
 	            }
 	           else if(k==27 || k==28 || k==31 || k==32 || k==42 || k==45 || k==47 || k==49 || k==51 || k==53 || k==57 || k==58 || k==61 || k==78 || k==84 || k==91 || k==96)
 				{
               ...
               if(k==125) 
 	            {
 	                %>
 	              	...
 	              	<%
 	              	tempForentryNumberValues[0]= "<b>Sanctioned<br>(Number)</b>";
 	              	tempForentryNumberValues[1]= "<b>In Position<br>(Number)</b>";
  				  	  tempForentryNumberValues[2]= "<b>Vacant since<br>what date (Number)</b>";
 	              
 	              l=l+3;
 	            } 	            
 	           else if(k==127 || k==139 || k==144)
 				{
 	              tempForentryNumberValues[0]= " ";
 	              tempForentryNumberValues[1]= " ";
				  tempForentryNumberValues[2]= " ";
			  ...
			  if(k==0)
			    {
			      	tempForentryNumberValues[0]= "<font face='arial' size=3><b>Performance in <br>last year</b></font>";
              	  	tempForentryNumberValues[1]= "<font face='arial' size=3><b>Planned performance in<br>current year as compiled<br>from PHC & FRU plans</b></font>";
 	            ...
 	            { %>
				  ...
				  <%	
 	              tempForentryNumberValues[0]= "<b>Avaliable<br>(Number)</b>";
 	              tempForentryNumberValues[1]= "<b>Functioning<br>(Number)</b>";
 	              
 	              l=l+2;
 	            }
 	           else if(k==1 || k==4 || k==10 || k==12 || k==16 || k==21 || k==22 || k==25 || k==27 || k==28 || k==31 || k==32 || k==42 || k==45 || k==47 || k==49 || k==51 || k==53 || k==57 || k==58 || k==61 || k==63 || k==64 || k==67 || k==70 )
			    {
			      	tempForentryNumberValues[0]= " ";
              	  	tempForentryNumberValues[1]= " ";
