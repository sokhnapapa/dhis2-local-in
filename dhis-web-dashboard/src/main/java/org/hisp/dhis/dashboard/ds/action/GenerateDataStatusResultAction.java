    ...
    implements Action
{
        ...
        throws Exception
    {
        ...
        else if ( facilityLB.equals( "immChildren" ) )
        {
            ...
            {
                OrganisationUnit o = organisationUnitService.getOrganisationUnit( Integer.parseInt( orgUnitIterator
                    .next() ) );
                orgUnitList.add( o );
        ...
        /*
         * List<OrganisationUnit> dataSetOrgUnit = new
         * ArrayList<OrganisationUnit>(); for( Source s1 : dSetSource ) { int
         * sid = s1.getId(); OrganisationUnit ou =
         * organisationUnitService.getOrganisationUnit( sid );
        ...
        while ( orgUnitListIterator.hasNext() )
        {
            ...
            while ( periodIterator.hasNext() )
            {
                ...
                System.out.println( "Sourceid is" + orgUnitInfo + "DataStatus is" + dataStatusPercentatge + "period is"
                    + periodInfo );
