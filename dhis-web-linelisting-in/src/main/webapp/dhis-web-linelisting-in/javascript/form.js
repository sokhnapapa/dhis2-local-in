    ...
    for( var element in jsllElementOptions)
    {
        ...
        if( options == null || options.length == 0 )
        {
            ...
            else if(type=='calender')
            {
                if(i==jsllElementSize)
                {
                    oCell.innerHTML = "<input name='"+tempStr+"' id='"+tempStr+"' type='text' onchange='addLLBNewRow()' onkeypress='return keyPress(event, this)' style='width:10em'> <img src='../images/calendar_icon.gif' width='16' height='16' id='"+date+"' cursor: pointer;' title='$i18n.getString( 'date_selector' )' onmouseover='this.style.background='orange';' onmouseout='this.style.background='''>";
                ...
                {
                    oCell.innerHTML = "<input name='"+tempStr+"' id='"+tempStr+"' type='text' onkeypress='return keyPress(event, this)' style='width:10em'> <img src='../images/calendar_icon.gif' width='16' height='16' id='"+date+"' cursor: pointer;' title='$i18n.getString( 'date_selector' )' onmouseover='this.style.background='orange';' onmouseout='this.style.background='''>";
                    inputFieldVal =  tempStr;
                    butVal = date;
