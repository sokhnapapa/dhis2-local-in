...
public class LLDataSets
{
    ...
    public static final int LLB_BIRTHS_MALE = 23;
    public static final int LLB_BIRTHS_FEMALE = 24;
    ...
    public static final int LLD_DEATH_OVER5Y = 552;
    public static final int LLD_DEATH_OVER5Y_MALE = 553;
    public static final int LLD_DEATH_OVER5Y_FEMALE = 554;
    ...
    // 1133 : Diarrhoeal disease Above 5 years
    public static final int LLD_CAUSE_DE13 = 1133;
    // 1134 : Tuberculosis Above 5 years
    public static final int LLD_CAUSE_DE14 = 1134;
    // 1135 : Malaria Above 5 years
    public static final int LLD_CAUSE_DE15 = 1135;
    // 1136 : HIV/AIDS Above 5 years
    public static final int LLD_CAUSE_DE16 = 1136;
    // 1137 : Other Fever related Above 5 years
    public static final int LLD_CAUSE_DE17 = 1137;
    // 1138 : Pregnancy related death( maternal mortality) Above 5 years
    public static final int LLD_CAUSE_DE18 = 1138;
    // 1139 : Sterilisation related deaths Above 5 years
    public static final int LLD_CAUSE_DE19 = 1139;
    // 1140 : Accidents or injuries Above 5 years
    public static final int LLD_CAUSE_DE20 = 1140;
    // 1141 : Suicides Above 5 years
    public static final int LLD_CAUSE_DE21 = 1141;
    // 1142 : Animal Bites or stings Above 5 years
    public static final int LLD_CAUSE_DE22 = 1142;
    // 1143 : Other known Acute disease (any  known cause- sick for less than 3 weeks- no fever) Above 5 years
    public static final int LLD_CAUSE_DE23 = 1143;
    // 1144 : Other known Chronic disease( sick for more than 3 weeks, no fever) Above 5 years
    public static final int LLD_CAUSE_DE24 = 1144;
    // 1145 : Cause Not Known, Above 5 years
    public static final int LLD_CAUSE_DE25 = 1145;
    // 1146 : Respiratory Infections and Disease – other than tuberculosis Above 5 years
    public static final int LLD_CAUSE_DE26 = 1146;
    // 1147 : Heart disease and hypertension Above 5 years
    public static final int LLD_CAUSE_DE27 = 1147;
    // 1148 : Stroke and Neurological disease Above 5 years
    ...
    public static final int LLMD_AGG_AUDITED = 1483;
