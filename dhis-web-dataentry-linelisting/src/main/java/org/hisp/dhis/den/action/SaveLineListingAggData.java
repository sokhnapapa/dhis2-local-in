    ...
    implements Action
{
        ...
        throws Exception
    {
        ...
        if ( dataSet.getName().equalsIgnoreCase( LLDataSets.LL_BIRTHS ) )
        {
             ...
             * updateWeighs(organisationUnit, period, lineListSexValues,
             * lineListWeighValues); updateBreastFeeding(organisationUnit,
             * period, lineListSexValues, lineListBFValues);
             */
        ...
        else if ( dataSet.getName().equalsIgnoreCase( LLDataSets.LL_DEATHS ) )
        {
             ...
             * 
             * updateDeaths(organisationUnit, period, lineListDeathSexValues,
             * lineListDeathAgeValues, lineListDeathCauseValues);
             */
    ...
    private void getLineListingDataForLiveBirths()
    {
        ...
        while ( count1 < lineListWeighDes.length )
        {
            ...
            DataElementCategoryOptionCombo optionCombo3 = dataElementCategoryOptionComboService
                .getDataElementCategoryOptionCombo( optionComboId3 );
            ...
            DataElementCategoryOptionCombo optionCombo1 = dataElementCategoryOptionComboService
                .getDataElementCategoryOptionCombo( optionComboId1 );
            ...
            DataElementCategoryOptionCombo optionCombo2 = dataElementCategoryOptionComboService
                .getDataElementCategoryOptionCombo( optionComboId2 );
    ...
    private void getLineListingDataElementsForDeaths()
    {
        ...
        try
        {
            ...
            if ( newpath != null )
            {
                llMappingXMLFileName = newpath + File.separator + "dhis" + File.separator + "linelisting"
                    + File.separator + "LineListingDeathDEs.xml";
            }
        }
    ...
    private void getLineListingDataElementsForLiveBirths()
    {
        ...
        try
        {
            ...
            {
                llMappingXMLFileName = newpath + File.separator + "dhis" + File.separator + "linelisting"
                    + File.separator + "LineListingLiveBirthDEs.xml";
            }
        }
        catch ( NullPointerException npe )
        {
    ...
    private void updateBreastFeeding( OrganisationUnit organisationUnit, Period period, DataValue[] lineListSexValues,
        DataValue[] lineListBFValues )
    {
        int count1 = 0;
        int totalMBF = 0;
        int totalFBF = 0;
    ...
    private void updateWeighs( OrganisationUnit organisationUnit, Period period, DataValue[] lineListSexValues,
        DataValue[] lineListWeighValues )
    {
        int count1 = 0;
        int totalMBW = 0;
        int totalFBW = 0;
    ...
    private void updateDeaths( OrganisationUnit organisationUnit, Period period, DataValue[] lineListDeathSexValues,
        DataValue[] lineListDeathAgeValues, DataValue[] lineListDeathCauseValues )
    {
        int count1 = 0;
