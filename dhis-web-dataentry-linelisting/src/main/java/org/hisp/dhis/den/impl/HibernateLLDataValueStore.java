    ...
    implements LLDataValueStore
{
    ...
    public Map<String, String> processLineListDeaths( OrganisationUnit organisationUnit, Period periodL )
    {
        ...
        int[] aggDeIds = {
                            ...
                            LLDataSets.LLD_DEATH_OVER15Y_MALE, LLDataSets.LLD_DEATH_OVER15Y_FEMALE, 
                            LLDataSets.LLD_DEATH_OVER05Y_MALE, LLDataSets.LLD_DEATH_OVER05Y_FEMALE,
                            ...
                            LLDataSets.LLD_CAUSE_DE17, LLDataSets.LLD_CAUSE_DE17, LLDataSets.LLD_CAUSE_DE18,
                            ...
                            LLDataSets.LLD_CAUSE_DE29, LLDataSets.LLD_CAUSE_DE29, LLDataSets.LLD_CAUSE_DE30, LLDataSets.LLD_CAUSE_DE30,
                            LLDataSets.LLD_CAUSE_DE31, LLDataSets.LLD_CAUSE_DE31, LLDataSets.LLD_CAUSE_DE32, LLDataSets.LLD_CAUSE_DE32,
                            LLDataSets.LLD_CAUSE_DE33, LLDataSets.LLD_CAUSE_DE33, LLDataSets.LLD_CAUSE_DE34, LLDataSets.LLD_CAUSE_DE34,
                            LLDataSets.LLD_CAUSE_DE35, LLDataSets.LLD_CAUSE_DE35, LLDataSets.LLD_CAUSE_DE36, LLDataSets.LLD_CAUSE_DE36,
                            LLDataSets.LLD_CAUSE_DE37, LLDataSets.LLD_CAUSE_DE37, LLDataSets.LLD_CAUSE_DE40, LLDataSets.LLD_CAUSE_DE40,
                            LLDataSets.LLD_CAUSE_DE41, LLDataSets.LLD_CAUSE_DE41, LLDataSets.LLD_CAUSE_DE42, LLDataSets.LLD_CAUSE_DE42,
                            LLDataSets.LLD_CAUSE_DE43, LLDataSets.LLD_CAUSE_DE43, LLDataSets.LLD_CAUSE_DE44, LLDataSets.LLD_CAUSE_DE44,
                            LLDataSets.LLD_CAUSE_DE45, LLDataSets.LLD_CAUSE_DE45, LLDataSets.LLD_CAUSE_DE46, LLDataSets.LLD_CAUSE_DE46,
                            LLDataSets.LLD_CAUSE_DE47, LLDataSets.LLD_CAUSE_DE47, LLDataSets.LLD_CAUSE_DE48, LLDataSets.LLD_CAUSE_DE48,
                            LLDataSets.LLD_CAUSE_DE49, LLDataSets.LLD_CAUSE_DE49, LLDataSets.LLD_CAUSE_DE50, LLDataSets.LLD_CAUSE_DE50,
                            LLDataSets.LLD_CAUSE_DE51, LLDataSets.LLD_CAUSE_DE51, LLDataSets.LLD_CAUSE_DE54, LLDataSets.LLD_CAUSE_DE54,
                            LLDataSets.LLD_CAUSE_DE55, LLDataSets.LLD_CAUSE_DE55, LLDataSets.LLD_CAUSE_DE56, LLDataSets.LLD_CAUSE_DE56,
                            LLDataSets.LLD_CAUSE_DE57, LLDataSets.LLD_CAUSE_DE57, LLDataSets.LLD_CAUSE_DE58, LLDataSets.LLD_CAUSE_DE58,
                            LLDataSets.LLD_CAUSE_DE59, LLDataSets.LLD_CAUSE_DE59, LLDataSets.LLD_CAUSE_DE60, LLDataSets.LLD_CAUSE_DE60,
                            LLDataSets.LLD_CAUSE_DE61, LLDataSets.LLD_CAUSE_DE61, LLDataSets.LLD_CAUSE_DE62, LLDataSets.LLD_CAUSE_DE62,
                            LLDataSets.LLD_CAUSE_DE63, LLDataSets.LLD_CAUSE_DE63, LLDataSets.LLD_CAUSE_DE64, LLDataSets.LLD_CAUSE_DE64, 
                            LLDataSets.LLD_CAUSE_DE65, LLDataSets.LLD_CAUSE_DE65, LLDataSets.LLD_CAUSE_DE66, LLDataSets.LLD_CAUSE_DE66,
                            LLDataSets.LLD_CAUSE_DE67, LLDataSets.LLD_CAUSE_DE67, LLDataSets.LLD_CAUSE_DE68, LLDataSets.LLD_CAUSE_DE68,
                            LLDataSets.LLD_CAUSE_DE69, LLDataSets.LLD_CAUSE_DE69, LLDataSets.LLD_CAUSE_DE70, LLDataSets.LLD_CAUSE_DE70,
                            LLDataSets.LLD_CAUSE_DE71, LLDataSets.LLD_CAUSE_DE71, LLDataSets.LLD_CAUSE_DE72, LLDataSets.LLD_CAUSE_DE72,
                            LLDataSets.LLD_CAUSE_DE73, LLDataSets.LLD_CAUSE_DE73, LLDataSets.LLD_CAUSE_DE74, LLDataSets.LLD_CAUSE_DE74, 
                            LLDataSets.LLD_CAUSE_DE75, LLDataSets.LLD_CAUSE_DE75, LLDataSets.LLD_CAUSE_DE76, LLDataSets.LLD_CAUSE_DE76,
                            LLDataSets.LLD_CAUSE_DE77, LLDataSets.LLD_CAUSE_DE77, LLDataSets.LLD_CAUSE_DE78, LLDataSets.LLD_CAUSE_DE78,
                            LLDataSets.LLD_CAUSE_DE79, LLDataSets.LLD_CAUSE_DE79, LLDataSets.LLD_CAUSE_DE80, LLDataSets.LLD_CAUSE_DE80,
                            LLDataSets.LLD_CAUSE_DE81, LLDataSets.LLD_CAUSE_DE81, LLDataSets.LLD_CAUSE_DE82, LLDataSets.LLD_CAUSE_DE82,
                            LLDataSets.LLD_CAUSE_DE83, LLDataSets.LLD_CAUSE_DE83, LLDataSets.LLD_CAUSE_DE84, LLDataSets.LLD_CAUSE_DE84, 
                        };
        ...
        int[] aggDeOptComIds = {
            ...
            LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE,
            LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE,
            LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE,
            LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE,
            LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE,
            LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE,
            LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_MALE, LLDataSets.LLD_CAUSE_OPTIONCOMBO_FEMALE,
        ...
        queries[0] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ( 'O5YEAR', 'O15YEAR', 'O55YEAR')";
        
        
        // Death over 55 Years

        // Death Over 55 Years Male
        queries[1] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value LIKE 'O55YEAR' AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + ")";
        // Death Over 55 Years Female
        queries[2] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value LIKE 'O55YEAR' AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + ")";

        
        // Death 15 - 55 Years
        
        // Death Over 15 Year Male
        queries[3] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value LIKE 'O15YEAR' AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + ")";
        // Death Over 15 Year Female
        queries[4] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value LIKE 'O15YEAR' AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + ")";

        
        // Death 5 - 14 Years

        // Death 5 - 14 Years Male
        queries[5] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value LIKE 'O5YEAR' AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + ")";
        ...
        queries[17] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + ")";

        // 1121 Birth Asphyxia under one  month Male
        queries[18] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_ASPHYXIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1MONTH') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1121 Birth Asphyxia under one  month Female
        queries[19] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_ASPHYXIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1MONTH') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        ...
        queries[30] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_PNEUMONIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B5YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1127 : Pneumonia 1 year to 5 year Female
        queries[31] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_PNEUMONIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B5YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        ...
        queries[65] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_NOT_KNOWN + "' OR value LIKE '" + LLDataSets.LLD_OTHERS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O5YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        ...
        queries[70] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_HDH + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O5YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        
        // 1148 : Stroke and Neurological disease 5-14 years Male
        queries[71] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SND + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O5YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1148 : Stroke and Neurological disease 5-14 years Female
        queries[72] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SND + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O5YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";

        

        // 1199 : Malaria 15-55 years Male
        queries[73] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_MALARIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1199 : Malaria 15-55 years Female
        queries[74] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_MALARIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1200 : Malaria Above 55 years Male
        queries[75] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_MALARIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1200 : Malaria Above 55 years Female
        queries[76] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_MALARIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1201 : Tuberculosis 15-55 years Male
        queries[77] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_TUBER + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1201 : Tuberculosis 15-55 years Female
        queries[78] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_TUBER + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1202 : Tuberculosis Above 55 years Male
        queries[79] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_TUBER + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1202 : Tuberculosis Above 55 years Female
        queries[80] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_TUBER + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1203 : Malaria 1 year to 5 years Male
        queries[81] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_MALARIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B5YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1203 : Malaria 1 year to 5 years Female
        queries[82] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_MALARIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B5YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1204 : Tuberculosis 1 year to 5 year Male
        queries[83] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_TUBER + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B5YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1204 : Tuberculosis 1 year to 5 year Female
        queries[84] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_TUBER + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B5YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";

        
        // 1205 : Diarrhoeal disease 15-55 years Male
        queries[85] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_DIADIS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1205 : Diarrhoeal disease 15-55 years Female
        queries[86] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_DIADIS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1206 : HIV/AIDS 15-55 years Male
        queries[87] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_HIVAIDS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1206 : HIV/AIDS 15-55 years Female
        queries[88] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_HIVAIDS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1207 : Other Fever related 15-55 years Male
        queries[89] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OFR + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1207 : Other Fever related 15-55 years Female
        queries[90] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OFR + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1208 : Accidents or injuries 15-55 years Male
        queries[91] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_AI + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1208 : Accidents or injuries 15-55 years Female
        queries[92] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_AI + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1209 : Suicides 15-55 years Male
        queries[93] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SUICIDES + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1209 : Suicides 15-55 years Female
        queries[94] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SUICIDES + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1210 : Animal Bites or stings 15-55 years Male
        queries[95] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_ABS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1210 : Animal Bites or stings 15-55 years Female
        queries[96] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_ABS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1211 : Other known Acute disease 15-55 years Male
        queries[97] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OKAD + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1211 : Other known Acute disease 15-55 years Female
        queries[98] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OKAD + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1212 : Other known Chronic disease 15-55 years Male
        queries[99] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OKCD + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1212 : Other known Chronic disease 15-55 years Female
        queries[100] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OKCD + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1213 : Cause Not Known, 15-55 years Male
        queries[101] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_NOT_KNOWN + "' OR value LIKE '" + LLDataSets.LLD_OTHERS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1213 : Cause Not Known, 15-55 years Female
        queries[102] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_NOT_KNOWN + "' OR value LIKE '" + LLDataSets.LLD_OTHERS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1214 : Respiratory Infections and Disease 15-55 years Male
        queries[103] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_RID + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1214 : Respiratory Infections and Disease 15-55 years Female
        queries[104] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_RID + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1215 : Heart disease and hypertension 15-55 years Male
        queries[105] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_HDH + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1215 : Heart disease and hypertension 15-55 years Female
        queries[106] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_HDH + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1216 : Stroke and Neurological disease 15-55 years Male
        queries[107] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SND + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1216 : Stroke and Neurological disease 15-55 years Female
        queries[108] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SND + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O15YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";

        
        // 1217 : Diarrhoeal disease Above 55 years Male
        queries[109] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_DIADIS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1217 : Diarrhoeal disease Above 55 years Female
        queries[110] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_DIADIS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1218 : HIV/AIDS Above 55 years Male
        queries[111] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_HIVAIDS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1218 : HIV/AIDS Above 55 years Female
        queries[112] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_HIVAIDS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1219 : Other Fever related Above 55 years Male
        queries[113] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OFR + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1219 : Other Fever related Above 55 years Female
        queries[114] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OFR + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1220 : Accidents or injuries Above 55 years Male
        queries[115] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_AI + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1220 : Accidents or injuries Above 55 years Female
        queries[116] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_AI + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1221 : Suicides Above 55 years Male
        queries[117] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SUICIDES + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1221 : Suicides Above 55 years Female
        queries[118] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SUICIDES + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1222 : Animal Bites or stings Above 55 years Male
        queries[119] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_ABS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1222 : Animal Bites or stings Above 55 years Female
        queries[120] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_ABS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1223 : Other known Acute disease Above 55 years Male
        queries[121] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OKAD + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1223 : Other known Acute disease Above 55 years Female
        queries[122] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OKAD + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1224 : Other known Chronic disease Above 55 years Male
        queries[123] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OKCD + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1224 : Other known Chronic disease Above 55 years Female
        queries[124] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OKCD + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1225 : Cause Not Known, Above 55 years Male
        queries[125] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_NOT_KNOWN + "' OR value LIKE '" + LLDataSets.LLD_OTHERS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1225 : Cause Not Known, Above 55 years Female
        queries[126] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_NOT_KNOWN + "' OR value LIKE '" + LLDataSets.LLD_OTHERS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1226 : Respiratory Infections and Disease Above 55 years Male
        queries[127] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_RID + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1226 : Respiratory Infections and Disease Above 55 years Female
        queries[128] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_RID + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1227 : Heart disease and hypertension Above 55 years Male
        queries[129] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_HDH + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1227 : Heart disease and hypertension Above 55 years Female
        queries[130] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_HDH + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1228 : Stroke and Neurological disease Above 55 years Male
        queries[131] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SND + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1228 : Stroke and Neurological disease Above 55 years Female
        queries[132] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SND + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('O55YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";

        
        // 1229 : Immunization reactions 1 year to 5 year Male        
        queries[133] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_IMMREAC + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B5YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        ...
        queries[135] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_ASPHYXIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1230 Birth Asphyxia under one  day Female
        queries[136] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_ASPHYXIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1231 : Sepsis under one  day Male
        queries[137] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SEPSIS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1231 : Sepsis under one  day Female
        queries[138] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SEPSIS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1232 : Low Birth Weight under one  day Male
        queries[139] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_LOW_BIRTH_WEIGH + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1232 : Low Birth Weight under one  day Female
        queries[140] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_LOW_BIRTH_WEIGH + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1233 : Immunization reactions under one  day Male        
        queries[141] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_IMMREAC + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1233 : Immunization reactions under one  day Female
        queries[142] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_IMMREAC + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1234 : Others under one  day Male
        queries[143] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OTHERS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1234 : Others under one  day Female
        queries[144] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OTHERS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1235 : Not known under one  day Male
        queries[145] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_NOT_KNOWN + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1235 : Not known under one  day Female
        queries[146] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_NOT_KNOWN + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1DAY') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";

        
        
        // 1236 Birth Asphyxia under one  week Male
        queries[147] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_ASPHYXIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1236 Birth Asphyxia under one  week Female
        queries[148] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_ASPHYXIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1237 : Sepsis under one  week Male
        queries[149] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SEPSIS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1237 : Sepsis under one  week Female
        queries[150] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_SEPSIS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1238 : Low Birth Weight under one  week Male
        queries[151] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_LOW_BIRTH_WEIGH + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1238 : Low Birth Weight under one  week Female
        queries[152] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_LOW_BIRTH_WEIGH + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1239 : Immunization reactions under one  week Male        
        queries[153] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_IMMREAC + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1239 : Immunization reactions under one  week Female
        queries[154] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_IMMREAC + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1240 : Others under one  week Male
        queries[155] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OTHERS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1240 : Others under one  week Female
        queries[156] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OTHERS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1241 : Not known under one  week Male
        queries[157] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_NOT_KNOWN + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1241 : Not known under one  week Female
        queries[158] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_NOT_KNOWN + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1WEEK') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";

        
        // 1242 : Pneumonia 1 month to 5 year Male
        queries[159] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_PNEUMONIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1242 : Pneumonia 1 month to 5 year Female
        queries[160] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_PNEUMONIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1243 : Diarrhoeal disease 1 month to 5 year Male
        queries[161] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_DIADIS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1243 : Diarrhoeal disease 1 month to 5 year Female
        queries[162] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_DIADIS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1244 : Measles 1 month to 5 year Male
        queries[163] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_MEASLES + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1244 : Measles 1 month to 5 year Female
        queries[164] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_MEASLES + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1245 : Tuberculosis Above 55 years Male
        queries[165] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_TUBER + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1245 : Tuberculosis Above 55 years Female
        queries[166] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_TUBER + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1246 : Malaria 1 year to 5 years Male
        queries[167] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_MALARIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1246 : Malaria 1 year to 5 years Female
        queries[168] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_MALARIA + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1247 : Immunization reactions under one  week Male        
        queries[169] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_IMMREAC + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1247 : Immunization reactions under one  week Female
        queries[170] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_IMMREAC + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1248 : Other Fever related 1 month to 5 year Male
        queries[171] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OFR + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1248 : Other Fever related 1 month to 5 year Female
        queries[172] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OFR + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1249 : Others 1 month to 5 year Male
        queries[173] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OTHERS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1249 : Others 1 month to 5 year Female
        queries[174] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_OTHERS + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1250 : Not known 1 month to 5 year Male
        queries[175] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_NOT_KNOWN + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'M' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
        // 1250 : Not known 1 month to 5 year Female
        queries[176] = "SELECT COUNT(*) FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_DEATH_CAUSE + " AND value LIKE '" + LLDataSets.LLD_NOT_KNOWN + "' AND recordno IN ( SELECT recordno FROM lldatavalue WHERE sourceid = " + ouId + " AND periodid = " + pId + " AND dataelementid = " + LLDataSets.LLD_AGE_CATEGORY + " AND value IN ('B1YEAR') AND recordno IN (SELECT recordno FROM lldatavalue WHERE dataelementid = " + LLDataSets.LLD_SEX + " AND value = 'F' AND sourceid = " + ouId + " AND periodid = " + pId + "))";
